        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code class="bg-light px-2 py-1 rounded small"><?php echo e($payment->payment_reference); ?></code></td>
                        <td><strong class="text-success">₦<?php echo e(number_format($payment->amount, 2)); ?></strong></td>
                        <td><span class="text-muted"><?php echo e(ucfirst($payment->payment_method)); ?></span></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="<?php echo e(route('user.payments.show', $payment)); ?>" class="btn btn-outline-primary" title="View">
                                    <i class="ti ti-eye"></i>
                                </a>
                                <?php if($payment->receipt): ?>
                                <a href="<?php echo e(route('user.receipts.show', $payment->receipt)); ?>" class="btn btn-outline-success" title="Receipt">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macintosh/Documents/Projects/alfawzan/alfawzan-backend/resources/views/user/payments/index.blade.php ENDPATH**/ ?>