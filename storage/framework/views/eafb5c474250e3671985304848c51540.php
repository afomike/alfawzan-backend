...
<div class="card">
    ...
    <div class="card-body">
        <dl class="row">
            ...
            <dd class="col-sm-9"><?php echo e($payment->user->name); ?> (<?php echo e($payment->user->email); ?>)</dd>
            ...
            <?php if($payment->agentLink): ?>
            <dt class="col-sm-3">Agent Link:</dt>
            <dd class="col-sm-9"><?php echo e($payment->agentLink->name); ?></dd>
            <?php endif; ?>
            ...
            <dd class="col-sm-9">
                <a href="<?php echo e(route('user.receipts.show', $payment->receipt)); ?>" class="btn btn-sm btn-primary">View Receipt</a>
            </dd>
            <?php endif; ?>
        </dl>

        <a href="<?php echo e(route('admin.payments.index')); ?>" class="btn btn-secondary">Back</a>
    </div>
</div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macintosh/Documents/Projects/alfawzan/alfawzan-backend/resources/views/admin/payments/show.blade.php ENDPATH**/ ?>