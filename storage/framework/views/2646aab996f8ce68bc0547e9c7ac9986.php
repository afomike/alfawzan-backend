<?php $__env->startSection('title', 'Welcome - Alfawzan Driving School'); ?>
        ...
        <div class="row align-items-center g-0">
            <div class="col-lg-7 p-5">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('driving-school.register')); ?>" class="btn btn-lg fw-bold px-4" style="background: white; color: #6366f1; border: none;">
                        <i class="ti ti-user-plus me-2"></i>Register Now
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-lg fw-semibold px-4" style="background: rgba(255,255,255,0.15); color: white; border: 2px solid rgba(255,255,255,0.5);">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macintosh/Documents/Projects/alfawzan/alfawzan-backend/resources/views/welcome.blade.php ENDPATH**/ ?>